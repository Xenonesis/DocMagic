...
export const resumeTemplates: TemplateMetadata[] = [
  {
    ...
    description:
      'Professional resume template optimized for software engineering positions with emphasis on technical skills and project experience',
    category: 'resume',
    industry: 'technology',
  ...
  },
  {
    ...
    description:
      'Strategic marketing resume template highlighting campaign management, analytics, and growth achievements',
    category: 'resume',
    industry: 'marketing',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    description:
      'Comprehensive resume template for nurses, medical technicians, and healthcare professionals',
    category: 'resume',
    industry: 'healthcare',
    difficulty: 'intermediate',
...
export const presentationTemplates: TemplateMetadata[] = [
  {
    ...
    description:
      'Comprehensive pitch deck template for startups seeking investment, covering all essential elements investors expect',
  ...
  },
  {
    ...
    description:
      'Professional sales presentation template for client meetings, product demos, and proposal presentations',
    category: 'presentation',
    industry: 'sales',
    difficulty: 'intermediate',
...
export const letterTemplates: TemplateMetadata[] = [
  {
    ...
    description:
      'Comprehensive cover letter template that highlights your qualifications and enthusiasm for the position',
    category: 'letter',
    industry: 'general',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    description:
      'Professional business proposal letter template for presenting business opportunities and partnerships',
    category: 'letter',
    industry: 'business',
    difficulty: 'intermediate',
...
export const cvTemplates: TemplateMetadata[] = [
  {
    ...
    description:
      'Comprehensive CV template for academic professionals, researchers, and professors seeking academic positions',
    category: 'cv',
    industry: 'academia',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    description:
      'Specialized CV template for physicians, medical professionals, and healthcare practitioners',
    category: 'cv',
    industry: 'healthcare',
    difficulty: 'advanced',
