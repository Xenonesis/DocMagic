  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      >
        ...
        <div
          className={cn('absolute inset-0 bg-gradient-to-br', styles.accent)}
        ...
        <div
          className={cn(
            'absolute inset-3 rounded-2xl bg-transparent',
            styles.frame,
            'ring-offset-0 rounded-xl',
          )}
        />
        ...
        <div className="relative z-10 h-full w-full p-10 flex flex-col items-center justify-between text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className={cn('tracking-widest text-xs md:text-sm uppercase', styles.subtext)}>
              Certificate of
            </p>
            <h2
          ...
          {/* Recipient */}
          <div>
            <p className={cn('text-xs md:text-sm tracking-widest uppercase', styles.subtext)}>
              Awarded to
            </p>
            <h1
              className="mt-2 text-3xl md:text-5xl font-serif font-bold text-neutral-900 dark:text-neutral-100"
              style={{
                fontSize: `calc(1.25rem + ${fontScale / 100} * 1.75rem)`,
          ...
          <div className="w-full flex items-end justify-between gap-6 mt-4">
              ...
              {certificate.awardedBy || certificate.signatureImage ? (
                <div className="text-left">
                  {certificate.signatureImage ? (
                    ...
                    <div
                      className={cn(
                        'text-xl md:text-2xl font-[500] leading-none',
                        styles.signature,
                      )}
                  ...
                  <p className="mt-1 text-xs md:text-sm text-neutral-600 dark:text-neutral-300">
            ...
            {showSeal && (
              <div
                className={cn(
                  'w-16 h-16 md:w-20 md:h-20 rounded-full shadow-lg grid place-items-center text-white font-bold',
                  styles.seal,
                )}
              >
      ...
      {isPreview && (
        <p className="mt-3 text-center text-xs text-muted-foreground">
          Live preview. Generate to enable export options.
        </p>
      )}
    </div>
  );
