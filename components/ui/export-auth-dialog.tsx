...
export function ExportAuthDialog({
  ...
  const contentMap = {
    ...
    presentation: {
      ...
      description:
        'Create presentations freely, but sign in to export them as PDF or PowerPoint files.',
      benefits: [
    ...
    'ats-analysis': {
      ...
      description:
        'Get detailed ATS compatibility reports with personalized improvement suggestions.',
      benefits: [
    ...
    icon: {
      title: 'Sign in to Download Icons',
      description:
        'Create icons freely with AI, but sign in to download them in high-quality formats.',
      benefits: [
        'Download icons in high-resolution PNG and SVG formats',
        'Save your icons for future access',
        'Generate unlimited icons with Premium',
        'Free to start - No credit card required',
      ],
    },
    certificate: {
      ...
      description:
        'Design certificates freely, but sign in to download high-resolution PDFs and images.',
      benefits: [
