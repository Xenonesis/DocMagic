...
export function SponsorBanner() {
  return (
    <div className="sponsor-banner fixed top-0 left-0 right-0 z-50 py-2 sm:py-3 px-2 sm:px-4 text-center overflow-hidden w-full bg-background/95 backdrop-blur-sm border-b border-border/40">
