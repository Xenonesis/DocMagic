...
export function FloatingHelpButton() {
  ...
  return (
    <>
      ...
      {/* Help Menu */}
      {isOpen && (
        <Card className="fixed bottom-24 right-6 z-40 w-80 glass-effect border-blue-400/20 shadow-xl animate-in slide-in-from-bottom-5">
            ...
            <div className="pt-3 border-t border-border/20">
              <div className="bg-blue-50/50 dark:bg-blue-950/20 p-3 rounded-lg border border-blue-200/30">
                <p className="text-xs text-center">
                  💡 <strong>Quick Tip:</strong> All fields are optional in the guided resume builder!
                </p>
              </div>
            </div>
          </CardContent>
