...
export function ResumeTemplates({
  ...
  const sampleResumeData = {
    ...
    summary:
      'Innovative designer with 8+ years of experience creating user-centered digital products. Specialized in SaaS platforms and mobile applications with a focus on accessibility and inclusive design.',
    experience: [
      {
    ...
    projects: [
      {
        ...
        description:
          'Redesigned patient portal for major hospital system, improving completion rates by 45%',
      },
      {
              ...
              <div className="space-y-2">
                {Object.entries(sampleResumeData.links).map(([key, value]) => (
                  <div key={key} className="flex items-center gap-2">
                    ...
                    <a href={`https://${value}`} className="text-sm text-gray-700 hover:underline">
                      {value}
                    </a>
                  </div>
                ))}
    ...
    <div className="p-8 h-full bg-white" id="resume-preview">
      <div className="max-w-4xl mx-auto">
        <div className="p-6 rounded-lg mb-8 bg-gradient-to-r from-blue-500 to-blue-700">
          <h1 className="text-3xl font-bold text-white tracking-tight">{sampleResumeData.name}</h1>
              ...
              <div className="space-y-2">
                {Object.entries(sampleResumeData.links).map(([key, value]) => (
                  <div key={key} className="flex items-center gap-2">
                    ...
                    {key === 'website' && <Globe className="h-4 w-4 text-green-600" />}
                    {key === 'portfolio' && <Briefcase className="h-4 w-4 text-purple-600" />}
                    <a href={`https://${value}`} className="text-sm text-blue-600 hover:underline">
                      {value}
                    </a>
                  </div>
                ))}
    ...
    <div className="p-8 h-full bg-white" id="resume-preview">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2 space-y-8">
            <div>
              <h2 className="text-2xl font-bold mb-4 text-black dark:text-purple-800">Expertise</h2>
              <div className="space-y-3">
                {sampleResumeData.skills.map((skill, i) => (
                  <div key={i}>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4 text-black dark:text-purple-800">Education</h2>
              <div className="space-y-4">
                {sampleResumeData.education.map((edu, i) => (
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4 text-black dark:text-purple-800">Connect</h2>
              <div className="space-y-2">
                {Object.entries(sampleResumeData.links).map(([key, value]) => (
                  <div key={key} className="flex items-center gap-2">
          ...
          <div className="md:col-span-3 space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-4">
                {sampleResumeData.projects.map((project, i) => (
                  <div key={i} className="p-4 rounded-lg border border-purple-100 bg-white">
    ...
    <div className="p-8 h-full bg-white" id="resume-preview">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10">
          ...
          <div>
            <h2 className="text-lg font-normal mb-3 tracking-wider text-gray-700">PROFILE</h2>
            <p className="text-gray-700 leading-relaxed">{sampleResumeData.summary}</p>
          </div>

          <div>
            <h2 className="text-lg font-normal mb-3 tracking-wider text-gray-700">EXPERIENCE</h2>
            <div className="space-y-6">
              {sampleResumeData.experience.map((exp, i) => (
                <div key={i}>
                  <div className="flex justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-lg font-normal mb-3 tracking-wider text-gray-700">EDUCATION</h2>
              <div className="space-y-4">
                {sampleResumeData.education.map((edu, i) => (
                  <div key={i}>
            ...
            <div>
              <h2 className="text-lg font-normal mb-3 tracking-wider text-gray-700">SKILLS</h2>
              <div className="flex flex-wrap gap-2">
                {sampleResumeData.skills.map((skill, i) => (
                  <span key={i} className="px-2 py-1 text-sm text-gray-700">
                    {skill}
                  </span>
                ))}
              </div>
          ...
          <div>
            <h2 className="text-lg font-normal mb-3 tracking-wider text-gray-700">LINKS</h2>
    ...
    <div className="p-8 h-full bg-white" id="resume-preview">
      <div className="max-w-4xl mx-auto">
        <div className="border-b-4 border-amber-700 pb-6 mb-8">
          <h1 className="text-4xl font-bold text-amber-900">{sampleResumeData.name}</h1>
              ...
              <div className="space-y-3">
                {Object.entries(sampleResumeData.links).map(([key, value]) => (
                  <div key={key} className="flex items-center gap-2">
                    ...
                    <a
                      href={`https://${value}`}
                      className="text-gray-800 hover:text-amber-800 hover:underline"
                    >
                      {value}
                    </a>
                  </div>
    ...
    <div className="p-8 h-full bg-white" id="resume-preview">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start mb-8 pb-6 border-b-2 border-emerald-200">
          <div>
            <h1 className="text-3xl font-bold text-emerald-900">{sampleResumeData.name}</h1>
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
          Select a template that best represents your professional style. Click any template to
          preview and customize your resume.
        </p>
      </div>
        ...
        {templates.map((template) => (
          ...
          >
            ...
            <Card className="overflow-hidden h-full border-0 shadow-sm group">
              <div className={cn('h-48 relative overflow-hidden transition-all', template.preview)}>
          ...
          <DialogHeader className="p-6 pb-0">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" onClick={exportToWord} className="gap-2">
                  <Download className="h-4 w-4" />
                  Word
                </Button>
                <Button onClick={handleCustomizeTemplate} className="gap-2">
                  <Palette className="h-4 w-4" />
                  Customize
                </Button>
                <Button onClick={handleUseTemplate} className="gap-2 bolt-gradient text-white">
      ...
      <Dialog open={isCustomizing} onOpenChange={(open) => !open && setIsCustomizing(false)}>
        <DialogContent className="max-w-6xl p-6 overflow-hidden h-[90vh]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[calc(100%-120px)] overflow-hidden">
            <div className="overflow-y-auto pr-4">{renderCustomizationPanel()}</div>
