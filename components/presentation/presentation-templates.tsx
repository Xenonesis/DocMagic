  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold mb-2 bolt-gradient-text">
          Choose Your Style
        </h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Select a professional template that matches your presentation style. Each template
          includes optimized layouts, color schemes, and visual elements.
        </p>
      </div>
                ...
                <div className="absolute inset-0 p-4 flex flex-col">
                    ...
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg p-2 flex items-center justify-center">
                      <div className="w-full h-full bg-gradient-to-br from-white/30 to-white/10 rounded flex items-end justify-center gap-1 p-2">
                        {[60, 80, 45, 90, 70].map((height, i) => (
                          <div
                            key={i}
                            className={cn('w-2 rounded-t bg-gradient-to-t', template.accentColor)}
                            style={{ height: `${height}%` }}
                          />
                        ))}
                      </div>
                  ...
                  <div className="flex justify-center gap-1 mt-3">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div
                        key={i}
                        className={cn('w-2 h-2 rounded-full', i === 1 ? 'bg-white' : 'bg-white/40')}
                      />
                    ))}
                  </div>
                </div>
