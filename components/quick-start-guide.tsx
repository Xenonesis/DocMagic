            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {steps.map((step, index) => (
                <div key={index} className="relative group">
                  ...
                  <div
                    className={`relative flex flex-col items-start gap-3 p-4 rounded-xl glass-effect border ${step.borderColor} hover:scale-105 transition-all duration-300`}
                  >
                    {/* Step number and icon */}
                    <div className="flex items-center gap-3 w-full">
                      <div
                        className={`w-10 h-10 rounded-full ${step.gradient} flex items-center justify-center text-white font-bold text-sm shadow-lg group-hover:scale-110 transition-transform`}
                      >
                        {index + 1}
                      </div>
                      <div
                        className={`w-10 h-10 rounded-lg ${step.gradient} flex items-center justify-center group-hover:scale-110 transition-transform`}
                      >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-amber-800 dark:text-amber-200 leading-relaxed">
                    Sign in to save your documents, access them from any device, and unlock premium
                    features like unlimited exports and advanced AI customization!
                  </p>
                </div>
              </div>
            </div>
