...
export async function POST(request: Request) {
  try {
    ...
    const typeInstructions = {
      ...
      presentation: "Enhance this presentation topic to be more structured and clear about the key points, audience, and objectives.",
      resume: "Enhance this resume description to be more professional, achievement-focused, and impactful.",
...
- Return ONLY the enhanced prompt, no explanations or meta-commentary`;
    ...
    cleanedPrompt = cleanedPrompt.replace(/^(Enhanced prompt:|Enhanced:|Here's the enhanced prompt:)\s*/i, '');
    ...
    console.error("[Enhance Prompt] Error stack:", error instanceof Error ? error.stack : "No stack");
    return NextResponse.json(
      {
