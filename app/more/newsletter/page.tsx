...
import { NewsletterGenerator } from '@/components/more/newsletter-generator';
import { Sparkles, Mail, Zap, Star, Wand2 } from 'lucide-react';
        ...
        <div className="container py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-effect mb-4 sm:mb-6 shimmer">
              ...
              <span className="text-sm font-medium">Newsletter Builder</span>
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-7 sm:leading-8 text-muted-foreground max-w-2xl lg:max-w-3xl mx-auto px-4 sm:px-0">
              Design <span className="font-semibold text-yellow-600">beautiful newsletters</span> with{' '}
              <span className="font-semibold text-blue-600">content blocks</span> and{' '}
              <span className="font-semibold bolt-gradient-text">responsive layouts</span>
            </p>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-4 sm:gap-6">
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Content</span>
                <span className="text-muted-foreground text-xs ml-1">Blocks</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Responsive</span>
                <span className="text-muted-foreground text-xs ml-1">Design</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">HTML</span>
