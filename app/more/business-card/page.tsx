...
import { BusinessCardGenerator } from '@/components/more/business-card-generator';
import { Sparkles, CreditCard, Zap, Star, Wand2 } from 'lucide-react';
        ...
        <div className="container py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-effect mb-4 sm:mb-6 shimmer">
              ...
              <span className="text-sm font-medium">Business Card Studio</span>
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-7 sm:leading-8 text-muted-foreground max-w-2xl lg:max-w-3xl mx-auto px-4 sm:px-0">
              Design <span className="font-semibold text-yellow-600">stunning business cards</span>{' '}
              with <span className="font-semibold text-blue-600">customizable layouts</span> and{' '}
              <span className="font-semibold bolt-gradient-text">QR code integration</span>
            </p>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-4 sm:gap-6">
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Multiple</span>
                <span className="text-muted-foreground text-xs ml-1">Layouts</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">QR</span>
                <span className="text-muted-foreground text-xs ml-1">Integration</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Print</span>
            ...
            <div className="glass-effect p-6 sm:p-8 rounded-2xl max-w-2xl mx-auto hover:scale-105 transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Create memorable business cards that help you stand out
                </p>
              </div>
            </div>
          </div>
