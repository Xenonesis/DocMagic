...
import { IdCardGenerator } from '@/components/more/id-card-generator';
import { Sparkles, IdCard, Wand2 } from 'lucide-react';
        ...
        <div className="container py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-effect mb-4 sm:mb-6 shimmer">
              ...
              <span className="text-sm font-medium">ID Card Builder</span>
