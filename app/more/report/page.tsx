...
import { ReportGenerator } from '@/components/more/report-generator';
import { Sparkles, BarChart3, Zap, Star, Wand2 } from 'lucide-react';
        ...
        <div className="container py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-7 sm:leading-8 text-muted-foreground max-w-2xl lg:max-w-3xl mx-auto px-4 sm:px-0">
              Create <span className="font-semibold text-yellow-600">data-driven reports</span> with{' '}
              <span className="font-semibold text-blue-600">charts and tables</span> and{' '}
              <span className="font-semibold bolt-gradient-text">executive summaries</span>
            </p>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-4 sm:gap-6">
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Charts</span>
                <span className="text-muted-foreground text-xs ml-1">& Graphs</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Data</span>
                <span className="text-muted-foreground text-xs ml-1">Tables</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Executive</span>
                <span className="text-muted-foreground text-xs ml-1">Summary</span>
              </div>
            </div>
          </div>
