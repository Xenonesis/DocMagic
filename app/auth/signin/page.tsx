            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              >
                ...
                <div className="relative group">
                  <Input
                    ...
                    required
                    className="w-full px-4 py-3 text-sm sm:text-base rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-300"
                    disabled={isLoading}
                  />
                </div>
              </div>
              ...
              >
                ...
                <div className="relative group">
                  <Input
                    ...
                    required
                    className="w-full px-4 pr-12 py-3 text-sm sm:text-base rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-300"
                    disabled={isLoading}
                  />
              ...
              >
                <Button
                  ...
                  className="w-full bolt-gradient text-white font-semibold py-4 sm:py-5 rounded-xl relative text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:scale-[1.02] transition-all duration-300 focus:ring-4 focus:ring-blue-300 focus:outline-none group"
                ...
                >
                  ...
                  {!isLoading && (
                    <>
                      <div className="absolute inset-0 shimmer opacity-20 group-hover:opacity-40 transition-opacity duration-500 z-10 rounded-xl"></div>
                    </>
                  )}
                </Button>
              </div>
