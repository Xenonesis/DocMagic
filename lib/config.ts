...
export const isStripeEnabled =
  STRIPE_CONFIG.ENABLED && !!STRIPE_CONFIG.PUBLISHABLE_KEY && !!STRIPE_CONFIG.SECRET_KEY;
...
export const getApiUrl = (path: keyof typeof PATHS.api) => `${getBaseUrl()}${PATHS.api[path]}`;
